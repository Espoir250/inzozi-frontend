...
export const Hero: React.FC = () => {
  ...
  const [activeCreatorTab, setActiveCreatorTab] = useState<
    "monetization" | "sponsorship" | "analytics"
  >("monetization");
    ...
    <div className="flex-1 flex flex-col items-center py-16 px-6 md:px-12 max-w-7xl mx-auto w-full">
      ...
      <div className="text-center max-w-3xl mb-16">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
          ...
          <span className="text-gradient-brand">Inzozi</span> Into Real Income
        </h1>
        <p className="text-lg text-zinc-400 leading-relaxed mb-8">
          InzoziMarket is a next-generation marketplace bridging creators,
          audiences, and brands within an integrated digital ecosystem. Monetize
          media directly and coordinate sponsorships under escrow contract
          security.
        </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full mb-20 max-w-5xl">
        {[
          ...
          >
            <span className="block text-3xl font-extrabold text-white mb-1.5">
              {stat.number}
            </span>
      ...
      <div className="w-full mb-28">
        ...
        <p className="text-center text-zinc-500 text-sm mb-12 max-w-md mx-auto">
          Explore the InzoziMarket ecosystem by logging in as any of the four
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          <div className="glass-panel p-6 rounded-2xl hover-scale flex flex-col border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-6 flex-grow">
              Discover posts, support creators with tips, subscribe for
              exclusive blogs, and unlock premium videos.
            </p>
            <button
              onClick={() => handleRoleSelection("fan")}
          ...
          <div className="glass-panel p-6 rounded-2xl hover-scale flex flex-col border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-6 flex-grow">
              Build your dashboard, upload subscriber content, track visual
              analytics, and negotiate sponsorships.
            </p>
            <button
          ...
          <div className="glass-panel p-6 rounded-2xl hover-scale flex flex-col border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-6 flex-grow">
              Browse creator databases by engagement metrics, manage campaigns,
              chat directly, and lock escrow budgets.
            </p>
            <button
              onClick={() => handleRoleSelection("business")}
          ...
          <div className="glass-panel p-6 rounded-2xl hover-scale flex flex-col border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-6 flex-grow">
              Review verification requests, moderate flagged posts, inspect
              transaction logs, and oversee global stats.
            </p>
            <button
      ...
      <div className="w-full max-w-6xl mx-auto mb-28 border-t border-b border-white/5 py-20 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-zinc-400 text-sm md:text-base leading-relaxed">
            InzoziMarket equips creators with premium direct-to-audience
            monetization utilities, legally binding escrow protect partnerships,
            and live statistics to transform digital hobbyism into high-growth
            enterprise.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            <div className="text-center mt-3 text-xs text-zinc-500">
              💡{" "}
              <span className="font-semibold text-zinc-400">Interactive:</span>{" "}
              Use the video player controls or click the side cards to browse
              live platform mockup visuals.
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-2.5">
                ...
                >
                  <Heart
                    className={`w-4.5 h-4.5 ${activeCreatorTab === "monetization" ? "text-purple-400" : "text-zinc-400"}`}
                  />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-white">
                    {creatorBenefits.monetization.title}
                  </h3>
              ...
              <p className="text-zinc-400 text-xs leading-relaxed">
                Unlock subscriber-only posts and receive instant tips straight
                to your wallet, subject to negligible transaction costs.
              </p>
            </div>
            ...
            >
              <div className="flex items-center gap-3 mb-2.5">
                ...
                >
                  <Briefcase
                    className={`w-4.5 h-4.5 ${activeCreatorTab === "sponsorship" ? "text-cyan-400" : "text-zinc-400"}`}
                  />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-white">
                    {creatorBenefits.sponsorship.title}
                  </h3>
                  <span className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider">
              ...
              <p className="text-zinc-400 text-xs leading-relaxed">
                Connect with brands on contract terms. Sponsorship budgets are
                locked securely in digital escrow vaults.
              </p>
            </div>
            ...
            >
              <div className="flex items-center gap-3 mb-2.5">
                ...
                >
                  <TrendingUp
                    className={`w-4.5 h-4.5 ${activeCreatorTab === "analytics" ? "text-emerald-400" : "text-zinc-400"}`}
                  />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-white">
                    {creatorBenefits.analytics.title}
                  </h3>
                  <span className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider">
              ...
              <p className="text-zinc-400 text-xs leading-relaxed">
                Track revenue patterns, verify subscriber numbers, and measure
                absolute post engagement rates dynamically.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="glass-panel p-8 rounded-3xl border border-white/5 relative flex flex-col justify-between">
            <div className="absolute top-6 right-8 text-6xl text-purple-500/10 font-serif select-none pointer-events-none">
              “
            </div>
            <div className="space-y-4 mb-6">
              ...
              <p className="text-zinc-300 text-xs md:text-sm leading-relaxed italic">
                "Moving my content sponsorships to InzoziMarket's escrow vault
                eliminated payment delays. I received instant payouts when my
                milestones were approved! The brand integration is completely
                transparent."
              </p>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="glass-panel p-8 rounded-3xl border border-white/5 relative flex flex-col justify-between">
            ...
            <div className="space-y-4 mb-6">
              ...
              <p className="text-zinc-300 text-xs md:text-sm leading-relaxed italic">
                "My subscriber count grew by 40% in two months. Fans love the
                simple tipping interface and premium locked sketchbooks. The
                analytic boards gave me absolute clarity on what fabric designs
                my audience wants."
              </p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-zinc-500">
                  Fashion & Art Creator • Nairobi, Kenya
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="glass-panel p-8 md:p-12 rounded-3xl border border-purple-500/20 bg-gradient-to-r from-purple-950/20 via-black/40 to-cyan-950/20 text-center relative overflow-hidden">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">
            Launch Your Digital Value Today
          </h3>
          <p className="text-zinc-400 text-xs md:text-sm max-w-lg mx-auto mb-8 leading-relaxed">
            Create subscriptions, enable gratuities, and establish secure escrow
            brand sponsorships in minutes. Join thousands of creators building
