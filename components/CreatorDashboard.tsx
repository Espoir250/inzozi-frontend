...
export const CreatorDashboard: React.FC = () => {
  const { creatorBalance, posts, createPost, creators, currentUser, updateCreatorProfile } = useApp();
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-zinc-400 text-xs mt-1 max-w-2xl">
              These details power business discovery filters and help fans understand who you are before they subscribe or tip.
            </p>
          </div>
          {showProfileSaved && (
